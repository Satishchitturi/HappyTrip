...
namespace HappyTrip.Model.BusinessLayer.AirTravel
{
    ...
    public class FlightManager
    {
        ...
        /// </summary>
        /// <exception cref="FlightManagerException">Thorwn when unable to get flights</exception>
        /// <returns>Returns collections of flights</returns>
        public Flights GetSortedFlights()
        {
            ...
            try
            {
                ...
                Flights flights = SortFlights(flightsArr.ToList());
		...
		/// <summary>
        /// Method to sort list of flights
		/// </summary>
		/// <param name="flightList"></param>
		/// <returns>A custom collection of sorted flights</returns>
		private Flights SortFlights(List<Flight> flightList)
		{
            //CSPRBUG18.4 - Implementing Custom Collection
            //Flights - Custom Collection also Sorted with needed Interfaces
