...
namespace HappyTrip.DataAccessLayer.Common
{
    ...
    class CityDAO : DAO, ICityDAO
    {
        ...
        public bool UpdateCity(City city)
        {
            bool flag = false;
            //ADO.NET Bug
            //STYCBG15.4 - Unable to update the city
            //cityId initialized to 1 and used in query. This variable to be deleted. Not needed
            //int cityId = 1;

            IDbConnection conn = null;
            //ADO.NET Bug
            //STYCBG15.4 - Unable to update the city
            //Query should be given city id from city object
            ...
            try
            {
                ...
                conn.Open();
                IDbCommand cmd = conn.CreateCommand();
                cmd.CommandText = "select count(*) from cities where CityId = " + city.CityId + "";
                cmd.CommandType = CommandType.Text;
