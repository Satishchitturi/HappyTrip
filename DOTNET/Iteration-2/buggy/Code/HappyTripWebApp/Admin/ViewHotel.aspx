<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ViewHotel.aspx.cs" Inherits="HappyTripWebApp.Admin.ViewHotel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <center>
        <br />
        <asp:Label ID="Label18" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Verdana"
            Font-Overline="False" Font-Size="Larger" Font-Underline="True" Text="View Hotel"
            Style="text-align: center"></asp:Label>
        <br />
        <asp:GridView ID="HotelGridView" runat="server" CellPadding="4" Height="258px" Width="647px"
            AllowPaging="True" BackColor="White" BorderColor="#CC9966" BorderStyle="None"
            BorderWidth="1px" OnPageIndexChanging="HotelGridView_PageIndexChanging" PageSize="1">
            <%--<Columns>
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="HotelId" DataNavigateUrlFormatString="~/Admin/EditHotel.aspx?hotelid={0}"
                    Text="Edit" />
            </Columns>
