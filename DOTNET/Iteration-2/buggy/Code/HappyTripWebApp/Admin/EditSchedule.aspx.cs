...
namespace HappyTripWebApp.Admin
{
    public partial class EditSchedule : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            scheduleid = Request.QueryString["schedulid"].ToString();
        ...
        protected void btnCancel_Click1(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = "Unable to get Schedule to update";
            }
        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                lblError.Text = "Unable to Update Schedule";
            }
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (scheduleManager.UpdateScheduleFlightCost(schedule, _class))
                    {
                        lblError.Text = "Flight Cost Updated";
                    }
                    else
                    {
                        lblError.Text = "Unable to Update Flight Cost";
                    }
            ...
            {
                lblError.Text = "Unable to edit. Please try again";
            }
        }
    }
}