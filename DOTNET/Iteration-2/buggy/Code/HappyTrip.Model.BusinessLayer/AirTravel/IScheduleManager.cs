...
namespace HappyTrip.Model.BusinessLayer.AirTravel
{
    public interface IScheduleManager : IAirTravelManager
    {
        ...
        bool UpdateSchedule(HappyTrip.Model.Entities.AirTravel.Schedule ScheduleInfo);
        ...
        bool UpdateScheduleFlightCost(HappyTrip.Model.Entities.AirTravel.Schedule scheduleInfo, HappyTrip.Model.Entities.AirTravel.FlightCost flightCostInfo);
    }
}
