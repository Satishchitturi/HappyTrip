    ...
    class CityDAO : DAO, ICityDAO
    {
        ...
        public DataSet GetStates()
        {
            ...
            try
            {
                ...
                using (IDataReader reader = db.ExecuteReader("getStates"))
                {
        ...
        public DataSet GetCities()
        {
            ...
            try
            {
                ...
                using (IDataReader reader = db.ExecuteReader("GetCities"))
                {
        ...
        public bool AddCity(City city)
        {
            ...
            try
            {
                using (IDataReader reader = db.ExecuteReader(CommandType.Text, "select count(*) from cities where CityName = '" + city.Name + "'"))
                {
                    while (reader.Read())
                    {
