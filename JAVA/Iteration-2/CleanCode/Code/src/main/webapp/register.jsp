...
<body class="FullWidth Welcome ">
	...
	<div id="Wrapper">
				...
				<div class="Left">
					<div class="col" id="stepContainer">
						...
						<div id="Step1" class="step" style="display: block;height:600px;">
							...
							<form method="post" action="registerprocess" id="signin_details" enctype="multipart/form-data">
       ...
       <dt><label for="airlineImage" class="required email">Account Picture</label></dt>
      <dd>
