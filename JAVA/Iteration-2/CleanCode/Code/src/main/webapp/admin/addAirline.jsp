...
<body class="Signin">
  ...
  <h1>Add</h1>
  <form method="post" action="addAirline" enctype="multipart/form-data">


    <dl class="vertical">
      <dt><label for="airlineName" class="required email">Airline name</label></dt>
      <dd><input name="airlineName" type="text" id="airlineName" class="required email" title="The name of the new airline" /></dd>
      ...
      <dd>
        <input name="airlineCode" type="text" id="airlineCode" size="24" value="" class="required password" title="The airline code" />
      </dd>
       <dt><label for="airlineImage" class="required email">AirlineImage</label></dt>
      <dd>
