...
import com.happytrip.dao.jpa.JpaFlightDao;
import com.happytrip.dao.jpa.JpaFlightRouteDao;
...
public class AdminServiceImpl implements AdminService {
	...
	public Flight getFlightByName(String name) {
		...
		JpaFlightDao jfd=new JpaFlightDao();
		return jfd.findByFlightName(name);
	}

	@Override
	public ScheduledFlight findScheduledFlightByIdAndDate(String date, long id) {
		// TODO Auto-generated method stub
		JpaFlightRouteDao jfrd=new JpaFlightRouteDao();
		return jfrd.findScheduledFlightByIdAndDate(date, id);
	}
