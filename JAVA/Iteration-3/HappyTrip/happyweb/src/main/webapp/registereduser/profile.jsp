...
<div id="Step1" class="step" style="display:block; height: 750px;">
  ...
  <form:form id="signin_details" action="saveProfile" method="post" commandName="UserProfile">
    <fieldset class="primary">
      ...
      <dl class="vertical">
        <dt><label for="username">Your email address</label><form:errors path="email" cssClass="error"/></dt>
		<form:hidden path="userId"/>
		<form:hidden path="userContact.userId"/>
        <dd><form:input path="email" name="email" id="username" type="text" size="28" value="${user.email}" readonly="true" />
          <span class="hint">This will be the username for login</span>
        </dd>
        <dt><label for="fullName">Your name *</label><form:errors path="fullName" cssClass="error"/></dt>
        <dd>
        ...
        <dt><label for="phone_number">Mobile Number *</label><form:errors path="userContact.mobileNo" cssClass="error"/></dt>
        <dd>
        ...
        <dt><label class="required" for="address1">Date Of Birth *</label><form:errors path="dateOfBirth" cssClass="error"/></dt>
        <dd><form:input path="dateOfBirth" class="datePicker required" type="text" name="dateOfBirth" title="Departure date" id="date" readonly="true"/></dd>
        <dt><label class="required" for="address1">Address *</label><form:errors path="userContact.address" cssClass="error"/></dt>
...
<%--    <dt><label class="required" for="city">City</label><form:errors path="userContact.city.cityName" cssClass="error"/></dt>
 ...
 --%>        
 		<dt><label class="required" for="pin">Pin Code (6 digits) *</label><form:errors path="userContact.pinCode" cssClass="error"/></dt>
        ...
        <dt><label class="required" for="miles">Miles earned</label><form:errors path="miles" cssClass="error"/></dt>
        <dd><form:input path="miles" class="required" name="miles" type="text" id="miles" size="10" title="Your miles" value="${user.miles}" readonly="true"/></dd>
      </dl>
