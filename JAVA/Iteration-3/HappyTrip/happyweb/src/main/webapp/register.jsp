	...
	<div id="Wrapper">
						...
						<div id="Step1" class="step" style="display: block;height:600px;">
							...
							<form:form method="post" action="registerprocess" commandName="UserRegister" id="signin_details" onsubmit="return checkPassword()">
								<fieldset class="primary">
									...
									<dl class="vertical">
										<dt>
											<label for="email">Your email address *</label><form:errors path="email" cssClass="error"/>
										</dt>

										<dd>
											<form:input id="email" path="email" type="text" size="32" maxlength="50"/><br>
        ...
        <dd>
											<form:input class="required" path="password" type="password"
												id="password" size="24" title="Your account password" maxlength="30" />
										</dd>
        <dt>
        ...
        <dd>
											<input class="required" name="retype_password"
												type="password" id="password_confirmation" size="24" maxlength="30"
        ...
        <dd>
          ...
          <form:input type="text" path="fullName"
												...
												class="required selflabel" title="Your full name" maxlength="30" />        
										</dd>
        <dt>
		...
		<dd><form:input path="dateOfBirth" class="datePicker required" type="text" name="dateOfBirth" title="You should be at least 18 years old" id="dateOfBirth" size="10" placeholder="Date of Birth" readonly="true"/></dd>
      </dl>
